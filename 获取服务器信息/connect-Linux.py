...
# # 连接服务器
# ssh.connect(hostname='172.18.23.11', port=22, username='root', password='test2020')
#
# # 执行命令
...
if __name__ == '__main__':
    # host = Linux('172.18.23.11', 'root', 'test2020')  # 传入Ip，用户名，密码
    # host = Linux('172.18.23.21', 'administrator', 'test2020!')
    host = Linux('172.18.22.201', 'root', 'test2020')
    ...
    while True:
        ...
        if msg == "exit":
            ...
            tishi_msg = res.split("\n")[-1]
            print(res.split("\n")[-1] + data.strip("\n"))
            # print(data.replace(msg, "").replace('\n', ''))